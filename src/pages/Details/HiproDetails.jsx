...
const HiproDetails = () => {
  ...
  return (
    <div className='bg-white'>
        <Navbar/>
        <hr />
        <div className='bg-[#ECF7FB] flex flex-col justify-center items-center  h-[2000px]'>
            <div className='mr-[20px] ml-[20px] relative bottom-[50px]' >
               <div>
...
{/* =========================================================== */}
          <hr className='bg-[#098590] h-[5px] mt-[20px] w-[80%] ml-[120px]' />
            <h1 className='ml-[150px] mt-[40px] text-[29px] text-[#098590] font-bold'>Hip Pro Data</h1>
         <div className='flex  '>
            {/* ==========Api fetching ================ */}
            <div className="bg-gray-100 p-4 rounded-md mt-2 ml-[150px] w-[450px] py-5 px-5 shadow-md h-[280px]">
...
{/* =================================Api fetching second ============== */}
<div className='mr-[40px] ml-[0px] mt-[30px] h-[350px]'>
<div className='flex '>
            {/* ==========Api fetching ================ */}
            <div className="bg-gray-100 p-4 rounded-md mt-2 ml-[150px] w-[450px] py-5 px-5 shadow-md h-[250px]">
      ...
      {/* ===============second card===================== */}
      <div className="bg-gray-100 p-4 rounded-md mt-2 ml-[200px] w-[450px] py-5 px-5 shadow-md h-[250px]">
...
{/* ===================Third api end ================================== */}
            ...
            <div className='bg-[#E1F0F2] mr-[250px ] ml-[50px] relative bottom-[150px] w-[1100px] h-[500px] mt-[100px] shadow-md'>
    ...
    <div className='flex relative top-24 justify-center gap-[100px] text-[19px] text-[#098590] font-[600]'>
     <input type="text" className='bg-white rounded-[36px] p-2  ' placeholder='20-10-2023' />
      ...
      <div className="container mx-auto p-2 mt-[100px] w-[950px] bg-white shadow-md">
      <table className="table-auto border border-collapse border-#098590 bg-white   w-full">
        <thead>
