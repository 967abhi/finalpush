  ...
  return (
    <div className='bg-white'>
      ...
      <div className='bg-[#F5FBFB] absolute left-[256px] top-[142px] w-[1255px] h-[805px]'>
        <div>
        <h1 className="text-3xl font-bold ml-4 mt-5 text-[#098590]">Cloud Drive</h1>
            <div className="cloud_drive">

    <div className="details mt-6 ml-10 w-[1050px] h-[250px] bg-white shadow-md rounded-[12px]">
        ...
        <div className="flex items-center mt-4">
            ...
            <div className="flex flex-row gap-[175px] ml-[10px]">
                ...
                <MdFileDownload  className='absolute left-[967px] text-black cursor-pointer'/>
